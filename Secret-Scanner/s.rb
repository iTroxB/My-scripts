...
STRINGS_SENSIBLES = [
    ...
    'access', 'access_code', 'access_token', 'action', 'address', 'admin', 'admin_email', 'administration', 'admin_password', 'aes_key', 'api', 
    'api_key', 'apikey', 'apisecret', 'api_token', 'api_url', 'app_key', 'auth', 'authentication', 'authentication_header', 'authorization', 
    'auth_password', 'auth_token', 'auth_user', 'aws_access_key', 'aws_access_key_id', 'aws_secret_access_key', 'aws_secret_key', 
    'azure_client_secret', 'azure_key', 'azure_storage_key', 'base64_decode', 'base64_encoded', 'base_url', 'basic_auth', 'bastion_host', 
    'bastion_user', 'bearer', 'bearerauth', 'bearer_token', 'begin certificate', 'begin dsa private key', 'begin openssh private key', 
    'begin private key', 'begin rsa private key', 'billing_key', 'callbacks', 'callback_url', 'cc_number', 'certificate', 'child_process', 
    'client_id', 'client_secret', 'cloudinary_api_secret', 'cmd', '--', 'config', 'configuration', 'connection_string', 'conn_str', 
    'cookie_secret', 'credential', 'credit_card', 'csrf_token', 'curl -x', 'cvv', 'database_url', 'db_host', 'db_name', 'db_password', 
    'db_port', 'db.query', 'db_user', 'db_username', 'debug', 'decryption_key', 'delete', 'delete from', 'digitalocean_token', 
    'discord_webhook', 'django_secret_key', 'dns_name', 'dns_zone', 'docker_hub_token', 'document.write', 'domain', 'dotenv', 'driver', 
    'drop table', 'email', 'encryption_key', 'encryption_salt', '-----end', 'endpoint', '.env', 'env', 'env_file', 'environment', 
    'environment_type', 'env_secret', 'eval(', 'eval.+.+.+', 'exec(', 'exec.+.+.+', 'exec(`|\s', 'exec_sql', 'expiry_date', 'firebase_key', 
    'flask_secret_key', 'ftp_password', 'gcp_service_account', 'github_token', 'gitlab_token', 'google_api_key', 'hash', 'heroku_api_key', 
    'hmac', 'hmac_key', 'host', 'hostname', 'id', 'identification', 'import os', 'information_schema', 'ini', 'innerhtml =', 'insert', 
    'insert into', 'internal_ip', 'invite_code', 'ip', 'ipaddr', 'ip_address', 'iv', 'jdbc', 'jdbc_url', 'jwt', 'jwt_secret', 'jwt_token', 
    'key', 'keystore', 'keystore_password', 'knex.raw', 'license_key', 'localhost', 'localstorage.setitem',  
    'localstorage.setitem("token", rawtoken)', 'login', 'login_token', 'master_key', 'mongodb_uri', 'mongo_uri', 'mysql_password', 
    'mysql.query', 'nc -e', 'netcat', 'network_key', 'new buffer.+.+.+', 'nextauth_secret', 'node_env', 'npm_token', 'oauth', 'oauth2', 
    'oauth_token', 'odbc', 'openai_api_key', "' or '' = '", 'or 1=1', 'os.environ', 'passwd', 'password', 'payment_token', 
    'personal_access_token', 'pgp_key', 'phone', 'port', 'private_ip', 'private_key', 'prod_env', 'properties', 'proxy_url', 'public_ip', 
    'public_key', 'pwd', 'query', 'query.+.+.+', 'rawquery', 'raw_sql', 'redirect', 'redis_url', 'refresh_token', 'remote_host', 
    'root_password', 'root_token', 'rsa_key', 's3_bucket', 'salt', 'secret', 'secret_key', 'secret_key_base', 'select', 'select * from', 
    '"select * from users where id = " + userinput', 'sendgrid_api_key', 'sendgrid_key', 'sentry_dsn', 'sequelize.query', 'server_url', 
    'session_key', 'session_secret', 'sessionstorage.setitem', 'session_token', 'settings', 'signing_key', 'slack_token', 'slack_webhook', 
    'smtp_pass', 'smtp_user', 'spring_datasource_password', 'sql', 'sql_query', 'ssh_config', 'ssh-dss', 'ssh_key', 'sshpass', 'ssh-rsa', 
    'ssl_cert', 'stripe_api_key', 'stripe_secret_key', 'subnet_id', 'subprocess', 'superuser_password', 'sysobjects', 'system(', 
    'system.+.+.+', 'telegram_bot_token', 'test_mode', 'token', 'truststore', 'twilio_auth_token', 'twilio_sid', 'twilio_token', 
    'unescaped', 'unsafe_query', 'unsanitized', 'update', 'update set', 'url', 'user', 'userinput', 'username', 'user_password', 
    'user_token', 'vault_key', 'vault_token', 'verbose', 'vpc_id', 'wan_ip', 'webhook_url', 'wget http', 'window.name', 'xp_cmdshell', 
    'xsrf_token', 'yaml', 'yml'
].freeze
